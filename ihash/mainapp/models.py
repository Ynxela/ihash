...
class IHashLink(models.Model):
    ...
    title = models.CharField(max_length=64, verbose_name='заголовок ссылки', default=None)
    image_url = models.CharField(max_length=256, verbose_name='ссылка на изображение', default=None)
